...
$sendmail_path = $_POST['sendmail_path'] ?? '/usr/bin/sendmail';
$sendmail_args = $_POST['sendmail_args'] ?? '';
$smtp_host = $_POST['smtp_host'] ?? 'mail.' . $_SERVER['HTTP_HOST'];
$smtp_port = $_POST['smtp_port'] ?? '25';
$smtp_auth = $_POST['smtp_auth'] ?? 'no';
$smtp_username = $_POST['smtp_username'] ?? '';
$smtp_password = $_POST['smtp_password'] ?? '';
$affiliates_dir = $_POST['affiliates_dir'] ?? "{$installation_path}affiliates/";
$joined_images_dir = $_POST['joined_images_dir'] ?? "{$installation_path}joined/";
$owned_images_dir = $_POST['owned_images_dir'] ?? "{$installation_path}owned/";
...
if (isset($_POST['install']) && $_POST['install'] == 'yes') {
    ...
    if ($_POST['installation_path'][strlen($_POST['installation_path']) - 1] != '/' &&
    ...
    if ($_POST['root_path_absolute'][strlen($_POST['root_path_absolute']) - 1] != '/' &&
...
if ($show_form) {
    ...
    <form action="install.php" method="post">
        ...
        <table>
            ...
            <tr>
                <td rowspan="2" valign="top" width="15%"><b>
                        Collective title
                    </b></td>
                <td>
        ...
        <table>
            ...
            <tr class="rowshade">
                <td rowspan="4" valign="top" width="15%"><b>
